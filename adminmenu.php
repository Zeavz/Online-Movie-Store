...
<div class=outterimage> 
 <img src="logo%20copy3.png" alt="logo" height="180px"> </div> 
    <div class=menua>
    <form method="post" action="adminsearch.php" > <br> <br>
      <input type="submit" class="btn btn-info" role="button" name="add" value="Add Movie" > 
      <input type="submit" class="btn btn-info" role="button" name="del" value="Remove A Movie" > 
          <input type="submit" class="btn btn-info" role="button" name="edit" value="Edit A Movie" > 
     <input type="submit" class="btn btn-info" role="button" name="userm" value="Show Movies Bought From Users" > 
           <input type="submit" class="btn btn-info" role="button" name="alluser" value="Show All Users Information"> 
